            ...
            <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" >
                <div className="md:flex w-full">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        ...
                        <LoginForm username={loginusername} password={loginpassword} formSubmit={submitLogin} setLoginUsername={setLoginUsername} setLoginpassword={setLoginpassword} role={role} setRole={setRole} confirmadmin={confirmadmin} setConfirmadmin={setConfirmadmin} />
                    </div>
                </div>
            </div>
        </div>
