    ...
    return (
        <section className="bg-[#fcfcfc] p-16 flex flex-col gap-[5rem]">
            <div className="flex flex-col lg:flex-row gap-[79px] ">
                ...
                <div className={`mt-[4rem] flex-col gap-[2.5rem] ${loading ? "hidden" : "flex"}`}>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="flex gap-4 capitalize mt-[1rem] w-full">
                            <li className="w-[40px] font-bold h-[40px] flex justify-center items-center rounded-full cursor-pointer text-base text-[#666] hover:shadow-xl hover:bg-gray-300" onClick={() => { setSize("large") }}>L</li>
                            <li className="w-[40px] font-bold h-[40px] flex justify-center items-center rounded-full cursor-pointer text-base text-[#666] hover:shadow-xl hover:bg-gray-300" onClick={() => { setSize("small") }}>S</li>
                            <li className="w-[40px] font-bold h-[40px] flex justify-center items-center rounded-full cursor-pointer text-base text-[#666] hover:shadow-xl hover:bg-gray-300" onClick={() => { setSize("medium") }}>M</li>
                        </ul>
                    </div>
